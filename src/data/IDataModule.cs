...
{
    /// <summary>
    /// Attempts to get the data associated with the specified key from a data module.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to add the data to a data module.
    /// </summary>
    /// <param name="data">The data to add.</param>
    /// <returns>
    /// <c>true</c> if the data was added to the data module successfully; <c>false</c> if the data already exists.
    /// </returns>
    public bool TryAdd(IKeyed data);

    /// <summary>
    /// Attempts to remove a series of data that has the specified type from a data module.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to remove and return the data that has the specified key from a data module.
    /// </summary>
    ...
    /// <summary>
    /// Clears all keys and data from a data module.
    /// </summary>
    public void Clear();
}
